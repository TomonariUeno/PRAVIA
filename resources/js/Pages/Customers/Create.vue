                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="text" id="kana" name="kana" v-model="form.name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    <div v-if="form.errors.kana" class="text-red-500 text-sm">
                                                        {{ form.errors.kana }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="form.errors.tel" class="text-red-500 text-sm">
                                                        {{ form.errors.tel }}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="number" id="postcode" name="postcode" v-model.number="form.postcode" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    <div v-if="form.errors.postcode" class="text-red-500 text-sm">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="address" class="leading-7 text-sm text-gray-600">カナ</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="birthday" class="leading-7 text-sm text-gray-600">カナ</label>
                                                    ...
                                                    <div v-if="form.errors.birthday" class="text-red-500 text-sm">
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="flex items-center gap-6">
                                                    <label class="flex items-center">
                                                        <input type="radio" name="gender" v-model="form.gender" :value="1" class="mr-2">
                                                        男性
                                                    </label>
                                                    <label class="flex items-center">
                                                        <input type="radio" name="gender" v-model="form.gender" :value="0" class="mr-2">
                                                        女性
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="form.errors.memo" class="text-red-500 text-sm">
                                                        {{ form.errors.memo }}
                                                    </div>
                                                </div>
                                            </div>
